...
$error = null;
    ...
    if (!$name || !$email || !$password) {
        ...
        $balance = isset($_POST['balance']) ? (int)$_POST['balance'] : 200;
        AuthController::register($name, $email, $password, $balance);
...
<head>
    ...
    <style>
        ...
        .field:nth-child(3) { animation-delay: 0.9s; }
...
<body>
    <header class="w-full flex items-center justify-between px-[150px] py-8 bg-black text-white fixed top-0 left-0 z-40 fade-in">
        ...
        <nav class="flex items-center gap-10 text-lg">
            ...
            <a href="#" class="nav-link hover:text-[#987A01] fade-in delay-200">Impact</a>
            <a href="#" class="nav-link hover:text-[#987A01] fade-in delay-200">About Us</a>
        </nav>
    ...
    <div class="page">
        <div class="wrapper">
            <div class="card">
                ...
                <h2 class="title-font text-4xl font-semibold mb-8 text-center text-gray-800">Register</h2>
                ...
                <form method="POST">
                    ...
                    <div class = "field">
                        <label> Balance  </label>
                        <input name="balance" type="number" value="200" min="0">
                    </div>
                    ...
                    <p class="text-center mt-6 text-gray-600 footer-text">
                        ...
                        <a href="/login.php" class="text-[#987A01] font-medium hover:underline">Login</a>
                    </p>
                </form>
